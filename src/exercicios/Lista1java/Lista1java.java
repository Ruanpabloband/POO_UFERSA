...
public class Lista1java {
    ...
    /* 3.Faça um programa para valor de comissão de vendedores de peças, levando-se em consideração que sua comissão será de 5% do total da venda e que você tem os seguintes dados:
